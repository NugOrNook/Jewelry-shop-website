...
<body>
    ...
    date:<input type="text" name="date_order" value="<?=$row["date_order"]?>"><br>
    time_order:<input type="text" name="time_order" value="<?=$row["time_order"]?>"><br>
    qty_product:<input type="text" name="qty_product" value="<?=$row["qty_product"]?>"><br>
    username_cus:<input type="text" name="username_cus" value="<?=$row["username_cus"]?>"><br>
    id_product:<input type="text" name="id_product" value="<?=$row["id_product"]?>"><br>
    payment<input type="text" name="payment_status" value="<?=$row["payment_status"]?>"><br>
